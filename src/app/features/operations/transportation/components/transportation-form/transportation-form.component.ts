...
export interface TransportationFormValue {
...
@Component({
  ...
  templateUrl:
    './transportation-form.component.html',

  styleUrl:
    './transportation-form.component.css',
...
export class TransportationFormComponent {
  ...
  readonly submitLabel =
    input('transportation.save');

  readonly submitted =
    output<TransportationFormValue>();
