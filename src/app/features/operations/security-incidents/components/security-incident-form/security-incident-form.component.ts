...
export interface SecurityIncidentFormValue {
...
@Component({
  ...
  templateUrl:
    './security-incident-form.component.html',

  styleUrl:
    './security-incident-form.component.css',

  changeDetection:
    ChangeDetectionStrategy.OnPush
})
export class SecurityIncidentFormComponent {
  ...
  readonly submitLabel =
    input('securityIncidents.save');

  readonly submitted =
    output<SecurityIncidentFormValue>();
