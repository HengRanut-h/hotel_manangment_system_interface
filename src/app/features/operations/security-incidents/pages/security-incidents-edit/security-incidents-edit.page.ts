...
@Component({
  selector:
    'app-security-incidents-edit-page',
  ...
  templateUrl:
    './security-incidents-edit.page.html',

  styleUrl:
    './security-incidents-edit.page.css',

  changeDetection:
    ChangeDetectionStrategy.OnPush
})
export class SecurityIncidentsEditPage
  implements OnInit {
          ...
          error => {
            ...
            this.errorMessage.set(
              getSafeApiErrorMessage(
                error,
                this.translation.translate(
                  'securityIncidents.loadOneFailed'
                )
              )
            );
      ...
      .subscribe({
        ...
        next:
          updated => {
            ...
            this.toast.success(
              this.translation.translate(
                'securityIncidents.updateSuccess'
              )
            );
          ...
          error => {
            ...
            this.toast.error(
              getSafeApiErrorMessage(
                error,
                this.translation.translate(
                  'securityIncidents.updateFailed'
                )
              )
            );
          }
