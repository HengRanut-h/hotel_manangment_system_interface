...
export interface LostAndFoundFormValue {
...
@Component({
  ...
  templateUrl:
    './lost-and-found-form.component.html',

  styleUrl:
    './lost-and-found-form.component.css',

  changeDetection:
    ChangeDetectionStrategy.OnPush
})
export class LostAndFoundFormComponent {
  ...
  readonly submitLabel =
    input('lostAndFound.save');

  readonly submitted =
    output<LostAndFoundFormValue>();
