...
@Component({
  ...
  templateUrl:
    './lost-and-found-list.page.html',

  styleUrl:
    './lost-and-found-list.page.css',

  changeDetection:
    ChangeDetectionStrategy.OnPush
})
export class LostAndFoundListPage
  implements OnInit {
