...
@Component({
  ...
  templateUrl:
    './lost-and-found-edit.page.html',

  styleUrl:
    './lost-and-found-edit.page.css',

  changeDetection:
    ChangeDetectionStrategy.OnPush
})
export class LostAndFoundEditPage
  implements OnInit {
