...
@Component({
  ...
  templateUrl:
    './complaints-list.page.html',

  styleUrl:
    './complaints-list.page.css',

  changeDetection:
    ChangeDetectionStrategy.OnPush
})
export class ComplaintsListPage
  implements OnInit {
