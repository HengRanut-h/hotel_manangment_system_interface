...
export interface StayExtensionFormValue {
...
@Component({
  ...
  templateUrl:
    './stay-extension-form.component.html',

  styleUrl:
    './stay-extension-form.component.css',

  changeDetection:
    ChangeDetectionStrategy.OnPush
})
export class StayExtensionFormComponent {
  ...
  readonly submitLabel =
    input('stayExtensions.saveChanges');

  readonly submitted =
    output<StayExtensionFormValue>();
