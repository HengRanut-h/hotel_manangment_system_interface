...
import {
  UtilityMeter,
  UtilityMeterActiveRequest,
  UtilityMeterPagedResult,
  UtilityMeterQuery,
...
type ListResponse =
  | UtilityMeterPagedResult
  | ApiEnvelope<UtilityMeterPagedResult>;
...
export class UtilityMetersApiService {
  ...
  ): Observable<UtilityMeterPagedResult> {
  ...
  create(
    request: UtilityMeterUpsertRequest
  ): Observable<UtilityMeter> {
