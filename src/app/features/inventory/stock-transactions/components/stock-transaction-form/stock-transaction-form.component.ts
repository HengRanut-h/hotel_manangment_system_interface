...
export interface StockTransactionFormValue {
...
@Component({
  ...
  templateUrl:
    './stock-transaction-form.component.html',

  styleUrl:
    './stock-transaction-form.component.css',

  changeDetection:
    ChangeDetectionStrategy.OnPush
})
export class StockTransactionFormComponent {
  ...
  readonly submitLabel =
    input('stockTransactions.save');

  readonly submitted =
    output<StockTransactionFormValue>();
