...
export class ShiftListPage
  ...
  readonly status =
    signal<ShiftStatusFilter>(
      'all'
    );

  readonly sortBy =
    signal<ShiftSortField>(
      'name'
    );
        ...
        next:
          updated => {
            ...
            this.toast.success(
              this.translation.translate(
                active
                  ? 'shifts.activateSuccess'
                  : 'shifts.deactivateSuccess'
              )
            );
          ...
          error => {
            ...
            this.toast.error(
              getSafeApiErrorMessage(
                ...
                this.translation.translate(
                  active
                    ? 'shifts.activateFailed'
                    : 'shifts.deactivateFailed'
                )
              )
            );
